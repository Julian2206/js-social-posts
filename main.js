const posts = [
...

  {
    id: 8,
    content:
      "Ao! Che nun ce lo sai che io so l'unico post scritto in romanesco de tutta sta lista autogenerata! Dico e scrivo nummeri da quanno so nato, ce manca pure che me faccio un post autogennerato!",
...
/* Milestone 1 -
 ...
 rimuovendo i contenuti statici.
...
// create the postElement on HTML
/* const isImageNull = false; */

posts.forEach((post, index) => {
  const mainWrapper = document.getElementById("container");
  console.log(post);
  newImage = posts[index].author.image;

  mainWrapper.innerHTML += `<div class="post">
      ...
      <div class="likes js-likes">
          <div class="likes__cta">
              <a class="like-button  js-like-button" href="#" data-postid="1">
                  ...
                  <span class="like-button__label">${posts[index].is_liked}</span>
              </a>
          </div>
